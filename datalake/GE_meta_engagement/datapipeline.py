...
def main():
    ...
    for res in reader.query():
        # local_writer.sink(payload=res, folder_path=folder_path, folder_name=folder_name)
        azure_writer.sink(payload=res, folder_path=folder_path, folder_name=folder_name)
